...
{	int l, c;
	for(l=0; l<linhas; l++)
	{	for(c=0; c<colunas; c++)
		{	if(l<0.1*linhas) original[l][c] = maxValor;
		    if(l>0.9*linhas) original[l][c] = maxValor;
		    if(c<0.1*colunas) original[l][c] = maxValor;
		    if(c>0.9*colunas) original[l][c] = maxValor;
		}
	}
}

/*void espelhar1(int** original, int linhas, int colunas, int maxValor)
{	int l, c, aux;
